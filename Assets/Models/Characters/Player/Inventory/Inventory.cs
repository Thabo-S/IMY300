...
public class Inventory : MonoBehaviour
{
    ...
    [Tooltip("Radius of the SphereCast used for pickup detection. Larger = " +
             "more forgiving aim, but can also pick up items slightly off to " +
             "the side. Start small (0.1-0.3) and increase if pickup still " +
             "feels too finicky.")]
    public float pickupSphereRadius = 0.2f;
